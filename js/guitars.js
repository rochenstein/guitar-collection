...
const guitars = [
...

  {
    ...
    acquiredYear: 1995,
    finish: "Black",
    condition: "Original — Metallica sticker on body",
    body: "Unknown",
    neck: "Unknown",
...
By the following year I had saved up enough. The money came the way most of my money came at that age: working at a stables, feeding and watering horses, mucking out. Somewhere around two hundred Irish punts, which took a while.

My cousin Wesley and I got the train up from Kildare to Dublin and walked into Music Maker on Exchequer Street as we were both guitar shopping. Wesley was already playing at that point, having started on some kind of extreme-shaped BC Rich Warlock knockoff that looked like it meant business. He bought a Mustang by Fender guitar that is covered elsewhere. The fact that he chose a sunburst Stratocaster feels, in hindsight, like a Pearl Jam decision. He was a massive fan.

I bought this black Stratocaster copy with white pickguard, the Eric Clapton configuration, along with a little Park practice amplifier. The whole lot came to around two hundred Irish punts. Two cousins, two guitars, train home to Kildare.

Music Maker was a serious shop. Behind the counter at the time sat a BC Rich Mockingbird with a quilted top in an emerald green finish, what I believe was a true custom shop instrument with a mother of pearl shamrock inlay on the fretboard. It was positioned behind the counter in the way that shops position things that are not for the likes of you. I have thought about that guitar many times since. I have no idea if they ever sold it, or where it ended up, but if it was a genuine custom shop BC Rich it must be worth serious money now.
...
I still have it. It plays like what it is, but I have no intention of getting rid of it.`,
  ...
  {
    id: "mustang-strat-1995",
    number: "02",
    make: "Mustang by Fender",
    model: "Stratocaster",
    year: 1995,
    country: "Unknown",
    acquired: "1995",
    acquiredYear: 1995,
    finish: "Sunburst",
    condition: "Original — stickers and electrical tape",
    body: "Unknown",
    neck: "Unknown",
    pickups: "Single coil",
    featured: false,
...
It remains one of the better guitars in the collection relative to what it cost. I still need to look up the exact model number and country of origin, which I'll update here once I do.`,
  ...
  {
    id: "gibson-lp-smartwood-1999",
    number: "04",
    make: "Gibson",
    model: "Les Paul Smartwood",
    year: 1999,
    country: "USA",
    acquired: "1999",
    acquiredYear: 1999,
    finish: "Natural",
    condition: "Good — returned to factory stock",
    body: "Mahogany / Peroba top",
    neck: "Mahogany",
    pickups: "Humbuckers",
    featured: false,
    videos: [
...
I was drawn to the Gibson section. Among the things I played that day was a Gibson Hummingbird in Heritage Cherry, which made an impression on me that I wouldn't act on for nearly twenty-five years. But I also found the Smartwood range, which I had read about in Guitar World amagazine. Gibson were producing guitars using sustainable woods from renewable sources, which was forward thinking for the era. We have since seen Taylor embrace non-traditional ebony and watched Brazilian rosewood become a premium restricted material, so the instinct behind the Smartwood range looks prescient in hindsight.

This guitar is a Les Paul Studio shape with a top made from Peroba, a Brazilian hardwood, paired with mahogany on the back and neck. The neck is chunky, what I take to be a fifties profile, and it has always been one of the most comfortable guitars in the collection to play.
...
Over the years I swapped out various parts including locking tuners, but I recently returned it to factory stock. It remains a mainstay.`,
  ...
  {
    id: "gibson-gothic-explorer-1999",
    number: "05",
    make: "Gibson",
    model: "Gothic Explorer",
    year: 1999,
    country: "USA",
    acquired: "1999",
    acquiredYear: 1999,
    finish: "Satin Black",
    condition: "Good — Seymour Duncan pickups installed",
    body: "Mahogany",
...
It is a beautiful guitar. The neck is sleek with an ebony fretboard, and the only fretboard inlay is a single crescent moon and star at the 12th fret. The back of the headstock features a portrait of Orville Gibson. Unlike Hetfield's own Explorers, this one is front routed and has a pickguard. At some point I swapped out the original pickups for a Seymour Duncan 59 and JB set, which is a classic combination, though I will admit there was nothing wrong with the originals. I have no real explanation for that decision other than the universal guitar player impulse to change things.`,
...

  {
    ...
    number: "06",
    make: "ESP",
    model: "JH-3 (James Hetfield)",
    year: 1999,
    country: "Japan",
    acquired: "1999",
    acquiredYear: 1999,
    finish: "Black with hot rod pinstripe graphics",
    condition: "Excellent",
    body: "Mahogany",
...
What it shares with the JH-3 is the build quality that defines Japanese-made ESP guitars. The finish is immaculate. Every component, whether the EMGs, the original Floyd Rose or the Gotoh hardware, feels like it was chosen and fitted with care. There is a precision to these instruments that is difficult to articulate but immediately obvious when you pick one up. I have owned a lot of guitars and the Japanese ESPs sit at the top of the pile in terms of fit and finish. The neck on this one is slightly chunkier than you might expect from a guitar associated with shred playing, which I find suits it well.`,
  ...
  {
    id: "gibson-sparkle-explorer-2001",
    number: "08",
    make: "Gibson",
    model: "Sparkle Explorer",
    year: 2001,
    country: "USA",
    acquired: "September 2001",
    acquiredYear: 2001,
    finish: "Silver Sparkle / Mirror pickguard",
    condition: "Good",
    body: "Mahogany",
    neck: "Mahogany",
    pickups: "Humbuckers",
...
I went back to Mars Music. On the wall was a guitar I could not immediately explain. It was a Gibson Explorer with a silver sparkle finish and a mirror pickguard. It looked completely unhinged. I took it down half as a joke, played it, and fairly quickly realised it was serious underneath the spectacle. I later learned it was a limited edition run produced exclusively for Mars Music. I bought it. It has been known as Disco Stu ever since, after the Simpsons character.

We were due to fly home to Ireland on September 11th. We were eating breakfast before leaving for the airport when the news showed what appeared to be a plane that had crashed into one of the Twin Towers. It took a little while for what was actually happening to become clear. We went to the airport anyway, which was chaos, and learned that all flights across the United States had been grounded. We stayed in Florida for an additional week before we could get a flight home.

Disco Stu has been in the collection ever since. It is not a subtle guitar. It is, however, a very good one.`,
    shortStory: "A limited edition Mars Music Explorer in silver sparkle with a mirror pickguard, known as Disco Stu. Bought on the trip where we were stranded in Florida when flights were grounded on September 11th, 2001.",
    tags: ["electric", "humbucker", "gibson", "florida", "limited-edition"],
    emoji: "🎸"
  },
...

  {
    ...
    finish: "Natural",
    condition: "Good",
    body: "Sitka Spruce top / Sapele laminate back and sides",
    neck: "Mahogany / Ebony fretboard",
    pickups: "None",
    featured: false,
    videos: [],
...
It is a good first guitar. Small and light, comfortable to pick up, sounds pleasant with a slightly thin quality compared to a full-size dreadnought, which is the honest trade-off for the size. It is my only Taylor in the collection and I appreciate it for exactly what it is, something you can grab off the stand and play without ceremony.`,
  ...
  {
    id: "prs-singlecut-trem-2004",
    number: "10",
    make: "PRS",
    model: "Singlecut Trem",
    year: 2004,
    country: "USA",
    acquired: "2004",
    acquiredYear: 2004,
    finish: "Cherry Sunburst / 10-top Maple",
    condition: "Excellent",
    body: "Mahogany / Maple 10-top",
...
In the same shop, on the same day, Suzanne bought her Fender Aerodyne Stratocaster. That guitar is also in the collection.`,
  ...
  {
    id: "fender-aerodyne-strat-2004",
    number: "11",
    make: "Fender",
    model: "Aerodyne Stratocaster",
    year: 2004,
    country: "Japan",
    acquired: "2004",
    acquiredYear: 2004,
...
What Suzanne paid for it in 2004 I cannot remember, but the prices these guitars fetch on Reverb today suggest it was a bargain.`,
...

  {
    ...
    condition: "Good — nut slots widened",
    body: "Mahogany",
...
The only work it needed was widening a few nut slots, which was a straightforward fix. The previous owner must have been pulling his hair out over tuning stability without ever identifying the cause. Once that was sorted, it was a perfect player. Light, slim contour neck, classic rock tones on demand. No notes.`,
...

  {
    ...
    acquiredYear: 2007,
    finish: "Galaxy White",
    condition: "Good — DiMarzio pickups installed",
    body: "Basswood",
...
This is my favourite of the two. Rosewood fretboard, blue finish, and it has been a straightforward, reliable player since the day I bought it. No drama, no modifications, no complaints.`,
...

  {
    ...
    acquiredYear: 2008,
    finish: "Black",
    condition: "Good — MusiKraft replacement neck",
    body: "Alder",
...
The MusiKraft neck is excellent. My one criticism is that the nut slots were cut a little low, but that is not a difficult fix and the neck itself is exceptional. The guitar plays well and the roasted maple has a feel and stability that I really like.`,
  ...
  {
    id: "ibanez-rg8470z-2008",
    number: "16",
    make: "Ibanez",
    model: "RG8470Z J Custom",
    year: 2008,
    country: "Japan",
    acquired: "2008",
    acquiredYear: 2008,
    finish: "Black Onyx / Flamed Maple top",
    condition: "Good — fret levelling in progress",
...
The one significant issue is the frets. For a new guitar from the J Custom line, they were not level, which is a disappointing quality control failure on an otherwise sublime instrument. I have spent considerable time with fret files and a fret rocker addressing the high spots myself, which is slow and unforgiving work given that the frets are stainless steel. It will eventually go to a professional tech for a final level and dress. Everything else about the guitar is, without exaggeration, perfect, the fit, the finish, the hardware, the feel of the mahogany and maple together. The fret situation is a frustrating asterisk on an otherwise exceptional instrument.`,
  ...
  {
    id: "esp-eclipse-ii-2008",
    number: "17",
    make: "ESP",
    model: "Eclipse II Standard",
    year: 2008,
    country: "Japan",
    acquired: "2008",
    acquiredYear: 2008,
    finish: "Arctic White (now cream)",
    condition: "Excellent",
...
It is one of the guitars that is always within reach. It is very hard to fault.`,
...

  {
    ...
    acquiredYear: 2010,
    finish: "Natural",
    condition: "Good — well travelled",
    body: "Solid Spruce / Solid Mahogany",
    neck: "Mahogany",
    pickups: "None",
    featured: false,
    videos: [],
...
If I were doing the same trip today I would make a different call. There are far better options for travelling musicians now, compact travel guitars, foldable designs, and things like the Boss Waza Air headphones, which combine amp simulations, a wireless dongle and a decent set of headphones into one package. A small electric and a set of those would have been considerably more practical than a dreadnought in a soft case on a budget airline.
...
It is the only bass in the collection and it earns its place whenever I need one for a recording. Most recently it appeared on a cover of Seein' Stars by Turnstile.

Neil, if you ever read this, it is ready and waiting for you.`,
    shortStory: "Neil's bass. He left it at my house in the nineties. I am the custodian. Neil, if you ever read this, it is ready and waiting for you.",
    tags: ["bass", "squier", "fender"],
    emoji: "🎸"
  },
  ...
  {
    id: "gibson-hummingbird-standard-2023",
    number: "20",
    make: "Gibson",
    ...
    condition: "Excellent",
    body: "Mahogany / Sitka Spruce top",
    neck: "Mahogany",
...
I have used it to record Celtic fingerstyle pieces, and also, through the onboard pickup system with some distortion added, a cover of 1979 by the Smashing Pumpkins, which is exactly the kind of thing a Hummingbird should probably not be used for and was all the more enjoyable for it.`,
  ...
  {
    id: "fender-avii-tele-2023",
    number: "21",
    make: "Fender",
    model: "American Vintage II 1951 Telecaster",
    year: 2023,
    country: "USA",
...
This one came from Some Neck Guitars in Dublin, which is an excellent shop and worth a visit if you haven't been. It is a 2023 guitar that I picked up second hand in October 2024 at a price that made it difficult to walk away from. I tried it, thought about it for a few weeks, and went back for it.

The American Vintage II 1951 Telecaster is Fender doing a faithful recreation of the original, butterscotch blonde, black Bakelite pickguard, nitro finish. This is the Telecaster as far as I am concerned. The neck is maple and unambiguously chunky, what some would call a baseball bat profile, and the guitar is heavy and solid in a way that modern instruments often are not. None of that is a criticism. It feels substantial because it is substantial.

I have used it to record a cover of Reptilia by The Strokes, alongside the ES-345. The choice was deliberate, the Strokes' guitar setup pairs a semi-hollow with a Telecaster, and having both in the collection made it possible to replicate that properly. It is a guitar I reach for regularly. Based on this one experience, Fender's American Vintage line is doing exactly what it should be doing. This is very likely the only Telecaster I will ever own and I am perfectly happy with that.`,
    shortStory: "Bought second hand from Some Neck Guitars in Dublin in October 2024. A 2023 AVII recreation of the original 1951 Telecaster. Butterscotch, Bakelite pickguard, baseball bat neck. The only Telecaster I will ever need.",
    tags: ["electric", "single-coil", "fender", "telecaster"],
    emoji: "⚡"
  },

  {
    id: "fender-tvl-jazzmaster-2023",
    number: "22",
    make: "Fender",
    model: "Troy Van Leeuwen Jazzmaster",
    year: 2023,
    country: "Mexico",
    acquired: "July 2023",
    acquiredYear: 2023,
    finish: "Oxblood",
    condition: "Excellent — shimmed neck pocket",
    body: "Alder",
    neck: "Maple / 7.25\" radius",
...
Once set up to my preferences it is a joy. The tremolo is endlessly entertaining and the rhythm circuit, which confuses a lot of people on first encounter, rewards the time spent understanding it.`,
  ...
  {
    id: "yamaha-classical-2023",
    number: "23",
    make: "Yamaha",
    model: "CGS102A Classical Guitar",
    year: 2023,
    country: "Unknown",
    acquired: "2023",
    acquiredYear: 2023,
...
It is, as you would expect from Yamaha, a real instrument rather than a toy. Well made, properly set up, entirely fit for purpose. I also find myself picking it up for fingerstyle playing in the evenings while I wait for my daughter to brush her teeth before her bedtime story.`,
    shortStory: "Bought for my daughter to start her guitar journey. A proper instrument, not a toy. I pick it up for fingerstyle in the evenings while she brushes her teeth.",
    tags: ["acoustic", "classical", "nylon", "yamaha"],
    emoji: "🎵"
  },
...
I have used it to record a cover of Reptilia by The Strokes, alongside the Telecaster. The choice was deliberate, the Strokes' guitar setup pairs a semi-hollow with a Telecaster, and having both in the collection made it possible to replicate that properly.`,
...

  {
    ...
    finish: "Autumn Green",
    condition: "Excellent",
    body: "Mahogany / Spruce (chambered)",
...
const allTags  = [...new Set(guitars.flatMap(g => g.tags))].sort();
const allMakes = [...new Set(guitars.map(g => g.make))].sort();
