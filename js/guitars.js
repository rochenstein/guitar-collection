...
I bought the black Stratocaster copy with white pickguard, the Eric Clapton configuration, along with a little Park practice amplifier. The whole lot came to around two hundred Irish punts. Two cousins, two guitars, train home to Kildare.

Music Maker was a serious shop. Behind the counter at the time sat a BC Rich Mockingbird with a quilted top in an extraordinary emerald green finish, what I believe was a true custom shop instrument with a mother of pearl shamrock inlay on the fretboard. It was positioned behind the counter in the way that shops position things that are not for the likes of you. I have thought about that guitar many times since. I have no idea if they ever sold it, or where it ended up, but if it was a genuine custom shop BC Rich it must be worth serious money now. It was stunning.
...
It is a beautiful guitar. The neck is sleek with an ebony fretboard, and the only fretboard inlay is a single crescent moon at the 12th fret. The back of the headstock features a portrait of Orville Gibson. Unlike Hetfield's own Explorers, this one is front routed and has a pickguard. At some point I swapped out the original pickups for a Seymour Duncan 59 and JB set, which is a classic combination, though I will admit there was nothing wrong with the originals. I have no real explanation for that decision other than the universal guitar player impulse to change things.
...
Disco Stu has been in the collection ever since. It is not a subtle guitar. It is, however, a very good one.`,
...

  {
    ...
    finish: "Natural",
    condition: "Good",
    body: "Sitka Spruce top / Ply Mahogany back and sides",
    neck: "Mahogany / Ebony fretboard",
    pickups: "None",
    featured: false,
    videos: [
...
It is a good first guitar. Small and light, comfortable to pick up, sounds pleasant with a slightly thin quality compared to a full-size dreadnought, which is the honest trade-off for the size.`,
...

  {
    ...
    pickups: "PRS #6 (bridge) / PRS #6 (neck)",
    featured: true,
    videos: [
...
It is a cherry sunburst with a ten-top maple cap over a mahogany body, mahogany set neck, rosewood fretboard and PRS bird inlays. It is a beautiful guitar and I love it.`,
...

  {
    ...
    pickups: "ST-Vintage Single Coils",
    featured: false,
    videos: [],
    images: [
...
I have used it to record a cover of Reptilia by The Strokes, alongside the ES-345. The choice was deliberate, the Strokes' guitar setup pairs a semi-hollow with a Telecaster, and having both in the collection made it possible to replicate that properly. It is a guitar I reach for regularly. Based on this one experience, Fender's American Vintage line is doing exactly what it should be doing. This is very likely the only Telecaster I will ever own and I am perfectly happy with that.`,
...

  {
    ...
    body: "Alder",
    neck: "Maple / 7.25\" radius",
    pickups: "American Vintage '65 Jazzmaster",
    featured: false,
    videos: [
